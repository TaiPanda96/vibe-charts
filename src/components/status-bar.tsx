...
export function StatusBar() {
  ...
  const navigateToPreviousSheet = () => {
    ...
    const activeIndex = sheets.findIndex(
    ...
    <div className="w-full bg-[#c0c0c0] border-t border-[#808080] flex flex-col">
      ...
      <div className="flex items-center h-6 border-b border-[#808080]">
        <div className="flex items-center h-full">
          {/* Navigation buttons */}
          <button
            className="win98-toolbar-button h-full px-1"
            title="Start"
            onClick={navigateToFirstSheet}
          >
          ...
          <button
            ...
            onClick={navigateToPreviousSheet}
          >
      ...
      <div className="flex items-center h-5 px-2">
        <div className="win98-button mr-2 py-0 px-2 text-xs h-4 flex items-center">
          Start
        </div>
