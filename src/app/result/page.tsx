...
import { Download, Copy, RefreshCw, Share2, Mail, Link } from "lucide-react";
...
export default function ResultPage() {
  ...
  const downloadCSV = () => {
    ...
    const csvContent = [
      ...
      ...labels.map((label, i) =>
        [label, ...datasets.map((ds) => ds.data[i])].join(",")
      ),
    ].join("\n");
                  ...
                  <div className="space-y-3">
                    <div className="win98-window p-3">
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-1 text-xs">
                        {getTalkingPointsForAudience(chartConfig.audience).map(
                          (point, index) => (
                    ...
                    <div className="win98-window p-3">
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-1 text-xs">
                        <li>
                          Sales have consistently increased quarter over quarter
                        </li>
                        <li>Q4 shows the strongest performance at 81K</li>
                        <li>
                          The growth rate accelerated in Q3 with a 35.6%
                          increase from Q2
                        </li>
                        <li>
                          Overall yearly growth trend indicates successful
                          market strategies
                        </li>
                      </ul>
                    </div>
                        ...
                        {showShareOptions && (
                          <div className="absolute left-0 mt-1 win98-window bg-[#c0c0c0] p-1 z-10">
                            ...
                            <button
                              ...
                              onClick={() => {
                                alert(
                                  "Email sharing would be implemented here"
                                );
                                setShowShareOptions(false);
                              }}
                            >
                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                      ...
                      >
                        ...
                        <div className="p-3 bg-[#c0c0c0] flex">
                          ...
                          <div>
                            <p className="text-sm">
                              Chart for {activeSheet?.name || "Sheet1"} copied
                              as PNG!
                            </p>
                          </div>
                        </div>
                        <div className="bg-[#c0c0c0] p-2 flex justify-end border-t border-[#808080]">
                          <button
                            className="win98-button text-xs px-4"
                            onClick={() => setShowCopyNotification(false)}
                          >
                            OK
                          </button>
